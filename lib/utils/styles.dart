...
final signupPage_InfoSentence1 = GoogleFonts.openSans(
    fontSize: 28,
    fontWeight: FontWeight.normal, //signup page text 'lets get started'
);

final signupPage_InfoSentence2 = GoogleFonts.openSans(
    fontSize: 10,
    fontWeight: FontWeight.normal, //signup page text 'create an account to get all features'
);

final signupPage_ButtonTxts = GoogleFonts.openSans(
    fontSize: 12,
    fontWeight: FontWeight.normal, //signup page, texts inside the user info lines
);
...
final PreviousPage = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w600, //texts for the previous page such as; discounts & offer, categories, my cart...
);
...
final ItemBrandandPrice = GoogleFonts.openSans(
    fontSize: 13,
    fontWeight: FontWeight.normal, //item brand, price to be used in every necessary page
);

final ShoppingCart_PaymentRegular = GoogleFonts.openSans(
    fontSize: 14,
    fontWeight: FontWeight.normal, //shopping cart checkout prices fontweight is mixed, use bold it for regular
);

final ShoppingCart_PaymentBold = GoogleFonts.openSans(
    fontSize: 14,
    fontWeight: FontWeight.bold, //shopping cart checkout prices fontweight is mixed, use bold it for bold
);
...
final Product_BrandandDetails = GoogleFonts.openSans(
    fontSize: 12,
    fontWeight: FontWeight.normal, //product; name, overview, details, comments bar and description
);
...
final SellerProfile2_NotAvailable = GoogleFonts.openSans(
    fontSize: 12,
    fontWeight: FontWeight.w600, //seller profile2 page not available to adding cart
);
